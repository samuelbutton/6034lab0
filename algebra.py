...
def do_multiply(expr1, expr2):
    ...
    * expr1 is a Product, and expr2 is a Product
    ...
    isProd1 = isinstance(expr1, Product)
    isProd2 = isinstance(expr2, Product)

    # print("Expressions in multiply")
    # print(expr1)
    # print(expr2)
    if isProd1 and isProd2:
        newProduct = Product(list(expr1) + (list(expr2)))
        # print("New Product")
        # print(newProduct)
        return newProduct
    ...
    if isProd1:
        for term in expr2:
            ...
            # print(expr1)
            # print(term)
            terms += [multiply(expr1, term)]
    elif isProd2:
        for term in expr1:
            terms += [multiply(expr2, term)]
    else:
        for term1 in expr1:
            for term2 in expr2:
                terms += [multiply(term1, term2)]
    # print("Terms")
    # print(terms)
    return Sum(terms)
